...
function fetchLineChartData(start, end) {
  $.ajax({
    url: "http://localhost:8098/ethpredictions", // URL for line chart data (predictions)
    method: "GET",
    dataType: "json",
    data: {
      start: start,
...
function fetchCombinedChartData(start, end) {
  ...
  $.ajax({
    url: "http://localhost:8098/ethdata", // URL for historical data for the candlestick chart
    method: "GET",
    dataType: "json",
    data: {
      start: start,
